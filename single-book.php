                ...
                <header class="page-header">
                  <div class="entry-meta">
                    ...
                    <div class="entry-content">
                      ...
                      <p>Penerbit : <?php $test = get_post_meta($post->ID, "book_publisher_name", true); 
                      echo  $test; ?></p>
                      <p>Rating : <?php $test = get_post_meta($post->ID, "rating_book", true); 
                      echo  $test; ?></p>
                      <p>Author : <?php $test = get_post_meta($post->ID, "user-wp", true); 
                      echo  $test; ?></p>
